...
import Jobsapplied from "./components/Artist/Jobsapplied.jsx"
import PostJob from "./components/client/postjob.jsx"
import Signup from "./components/Signup.jsx"
import Login from "./components/login.jsx"
import About from "./components/about.jsx"
import ArtistProfile from "./components/Artist/artistProfile/artistProfil.jsx"
 ...
 this.setState({user})
    ...
    ChangePage(pathname,data){
     if(pathname==="/"){
      ...
      this.setState({page:<ArtistProfile/>})
