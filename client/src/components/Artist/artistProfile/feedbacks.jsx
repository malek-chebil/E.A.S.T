                ...
                <div className="ashade-testimonials-carousel">
                  <div className="ashade-testimonials-item align-center swiper-slide">
                    <div className="ashade-testimonials-item__content">
                      <p>
                        I'm not a professional model, but i like good photos, i
                        like to look pretty on my instagram channel and also i
                        like to earn some money on stock photos. Andrew helps me
                        in all of this and much more. Fantastic professional.
                        Lot of thanks!{this.props.feedbacks}
                      </p>
                    </div>
                  ...
                  <div className="ashade-testimonials-item align-center swiper-slide">
                    <div className="ashade-testimonials-item__content">
                      <p>
                        ...
                        And it looks brilliant. He managed to clearly convey all
                        the emotions of the event in his photos. Thank you,
                        Andrew!
                      </p>
                    </div>
                    <div className="ashade-testimonials-item__author">
                  ...
                  <div className="ashade-testimonials-item align-center swiper-slide">
                    <div className="ashade-testimonials-item__content">
                      <p>
                        ...
                        becoming a photo model. Andrew helped me make a gorgeous
                        portfolio photo and now I receive many offers from
                        well-known agencies. I am very grateful to Andrew for
                        his work.
                      </p>
                    </div>
                    <div className="ashade-testimonials-item__author">
                  ...
                  <div className="ashade-testimonials-item align-center swiper-slide">
                    <div className="ashade-testimonials-item__content">
                      <p>
                        ...
                        professional photographer. That was a long time ago and
                        now I sometimes appeal to Andrew for private photo
                        shoots.
                      </p>
                    </div>
                    <div className="ashade-testimonials-item__author">
